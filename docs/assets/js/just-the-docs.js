...
{"0": {
    ...
    "doc": "Paho MQTT Client Power Save",
    "title": "Paho MQTT Client Power Save",
    "content": "This example application shows how to use WFI32-IoT device low power modes, Extreme Deep sleep mode (XDS) , Deep sleep mode (DS), Sleep mode, and Idle mode along with Wi-Fi sleep mode(WSM) and Wi-Fi power off(WOFF). ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html#paho-mqtt-client-power-save",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html#paho-mqtt-client-power-save"
  },"18": {
    "doc": "Paho MQTT Client Power Save",
    "title": "Description",
    "content": "This example application demonstrates below functionalities, . | How to read room temperature data periodically using WFI32-IoT Board. | Connect to unsecured MQTT Broker using Paho MQTT Client and publishes temperature data to topic every 5 minutes. | The Device enters into configured sleep mode after receiving the publishes acknowledgement from MQTT Broker. | Device can wake-up from sleep modes using RTCC or Button Press(SW1). | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html#description",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html#description"
  },"19": {
    "doc": "Paho MQTT Client Power Save",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html#downloading-and-building-the-application"
  },"20": {
    "doc": "Paho MQTT Client Power Save",
    "title": "Setting up WFI32 IOT Board",
    "content": ". | Connect the USB port(J200) on the board to the computer using a micro-USB cable. | Home AP (Wi-Fi Access Point with internet connection) | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html#setting-up-wfi32-iot-board",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html#setting-up-wfi32-iot-board"
  },"21": {
    "doc": "Paho MQTT Client Power Save",
    "title": "Running the Application",
    "content": ". | Open the project and launch Harmony3 configurator. | Configure home AP credentials for STA Mode. | Currently MQTT Service is configured to run a MQTT Client in unsecured mode to connect to test.mosquitto.org on the mqtt port (1883). In case the user wants to change this config, please make the changes in the MQTT Service Module configurations as shown below: . | By default, application is configured to run into deep sleep modes (DS). Power peripheral library configuration details for DS mode as shown in below Harmony3 configurator project graph. | In case, user want to enable only extreme deep sleep modes (XDS) then below Harmony3 configurator modification is needed. | As extreme deep sleep modes (XDS) only support wakeup source as EXT INT0(Button Press (SW1)). | Disable RTCC functionality in Power peripheral library as shown in below Harmony3 configurator project graph | . | For all other supported sleep modes, user doesn’t require any Harmony3 configurator (MHC) changes. | . | Supported MCU Power save modes: . | Extreme deep sleep mode (XDS) (LOW_POWER_DEEP_SLEEP_MODE) and Step 5 above. | Deep sleep mode (DS) (LOW_POWER_DEEP_SLEEP_MODE). | Sleep mode (LOW_POWER_SLEEP_MODE). | Idle mode (LOW_POWER_IDLE_MODE). | . Note: Configuration to change MCU power save mode is “g_mcuSleepMode = MCU Power save mode” in application in apps_mqtt.c file, . | Supported Wi-Fi Power save modes: . | WIFI_WSM (Wi-Fi Sleep mode) | WIFI_WOFF (Wi-Fi Power OFF) | . Note: Configuration to change MCU power save mode is “g_wiFiSleepMode = Wi-Fi power save mode” in application in apps_mqtt.c file. | . | Save configurations and generate code via Harmony3 configurator (MHC). | Build and program the generated code into the hardware using its IDE. | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | The Board will start reading room temperature data every 5 second using on board temperature sensor. | The Board will connect to AP and then as per the default MQTT Service configuration, it shall connect to test.mosquitto.org and publish room temperature data on the topic ‘MCHP/Sample/a’ after 5 Minute. It also subscribes to topic ‘MCHP/Sample/b’ . | If any third party MQTT Client connects to test.mosquitto.org and subscribes to the topic ‘MCHP/Sample/a’, it will receive the periodic room temperature data being published by the MQTT Client running on the WFI32-IoT board. The default application will publish periodic room temperature data to a topic every 5 Minutes. | After receiving the publishes acknowledgement from MQTT Broker, device enter into sleep mode (XDS or DS),Sleep or idle mode along with Wi-Fi power save(WSM). | . | User can start performing the power measurement when the device prints the above console message “Published Msg Temperature =value in C” and UART console stop printing new messages. | The information on how to perform the power measurement with the WFI32-IoT board is available at https://microchipsupport.force.com/s/article/How-to-perform-the-low-power-measurement-on-WFI32-IoT-Board | The information on how to Design Low Power Application with WFI32 board is available at https://microchipsupport.force.com/s/article/How-to-design-low-power-application-using-WFI32-IoT-board | . | In default application, device will wake-up after 1 minute using RTCC as wake-up source. | User can press WFI32-IoT Board SW1 button to wake-up device at any time. | . | Details of wake-up source supported in low power modes. | Supported Wake-up sources: . | XDS : . | EXT INT0(button press using SW1) | . | DS, Sleep and Idle mode: . | EXT INT0(button press using SW1) and RTCC | Note: RTCC default application wakeup time is 1 Minute. | . | . | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html#running-the-application",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html#running-the-application"
  },"22": {
    "doc": "Paho MQTT Client Power Save",
    "title": "Paho MQTT Client Power Save",
    "content": ". ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/paho_mqtt_client_power_save/readme.html",
    "relUrl": "/apps/paho_mqtt_client_power_save/readme.html"
  },"23": {
    ...
    "content": "This example application acts as a web socket server enabled enabled with wifi station mode. ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html#web-socket-server",
    "relUrl": "/apps/web_socket_server/readme.html#web-socket-server"
  },"60": {
    "doc": "Web Socket Server",
    "title": "Description",
    "content": "This application demonstrates how a user can enable and utilize the Web Socket Server System service. The system shall run in freertos mode, and the application shall come up in STA mode. ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html#description",
    "relUrl": "/apps/web_socket_server/readme.html#description"
  },"61": {
    "doc": "Web Socket Server",
    "title": "Downloading and building the application",
    ...
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html#downloading-and-building-the-application",
    "relUrl": "/apps/web_socket_server/readme.html#downloading-and-building-the-application"
  },"62": {
    "doc": "Web Socket Server",
    "title": "Setting up PIC32MZ W1 Curiosity Board",
    ...
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html#setting-up-pic32mz-w1-curiosity-board",
    "relUrl": "/apps/web_socket_server/readme.html#setting-up-pic32mz-w1-curiosity-board"
  },"63": {
    "doc": "Web Socket Server",
    "title": "Running the Application",
    "content": ". | Open the project and launch Harmony3 configurator. | Configure the SSID and the credential of the for AP to be connected. | Configure the port for the client connections. | Save configurations and generate code via MHC. | Build and program the generated code into the hardware using its IDE. | Open the Terminal application (Ex.:Tera term) on the computer. | Connect to the “USB to UART” COM port and configure the serial settings as follows: . | Baud : 115200 | Data : 8 Bits | Parity : None | Stop : 1 Bit | Flow Control : None | . | The Board will come up in STA mode and it will get connected automatically to the configured AP: . | Connect the computer also to the same AP as that of the device and run the python script wss_client/wss_client.py. The script will be used to send data to server. The server will act as a echo server and send the data back to the client. | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html#running-the-application",
    "relUrl": "/apps/web_socket_server/readme.html#running-the-application"
  },"64": {
    "doc": "Web Socket Server",
    "title": "Web Socket Server",
    "content": ". ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/web_socket_server/readme.html",
    "relUrl": "/apps/web_socket_server/readme.html"
  },"65": {
    "doc": "OTA Boot Loader",
    ...
    "content": ". | Jumper J211 is connected between pins 2-3 (closer to xpro header) | Jumper J209 is disconnected | Jumpers J301 are disconnected (to use external programmer tool) | Remove resistor R220 as it is pulling up the pin used by the 3rd slider segment on the QT7 | . ",
    ...
    "doc": "IFTTT Demo",
    "title": "IFTTT Demo",
    "content": "This example application demosntrates how we can generate a trigger to IFTTT web platform to make it perform a specific action like sending a mail/ sms etc using an applet. ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/ifttt/readme.html#ifttt-demo",
    "relUrl": "/apps/ifttt/readme.html#ifttt-demo"
  },"119": {
    "doc": "IFTTT Demo",
    "title": "Description",
    "content": "IFTTT is short for “If This Then That”. IFTTT is a third-party web platform which uses applets for performing specific actions when they are triggered via a connection. This application demonstrates how a user can trigger a pre-existing applet. The application shall come up in STA mode, and will establish a TLS connection with maker.ifttt.com. It shall send a trigger every time the button (SW1) on the Curiosity Board is pressed. ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/apps/ifttt/readme.html#description",
    "relUrl": "/apps/ifttt/readme.html#description"
  },"120": {
    "doc": "IFTTT Demo",
    "title": "Downloading and building the application",
    ...
    "doc": "Release notes",
    "title": "Harmony 3 Wireless application examples for PIC32MZ W1 family  v3.6.1",
    "content": "Development kit and demo application support . Following table provides number of Wireless examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ W1 Curiosity Board | 20 | . New Features . | . | New Low power save demo added. | . | Please refer to the system services release notes. | . Bug fixes and Improvements . | Please refer to the system services release notes. | . Known Issues . | Due to an underlying issue in the underlying net repo, you need to turn off -Werror for the icmp.c file in your projects. | While programming the image into hardware, user may observe the “Target Device ID is an Invalid Device Id” warning which needs to be ignored. The issue will be resolved with new DFP package release. | . Development Tools . | MPLAB® X IDE v6.00 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.2 | . | MPLAB® XC32 C/C++ Compiler v3.01 | DFP 1.5.203 | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v361",
    "relUrl": "/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v361"
  },"127": {
    "doc": "Release notes",
    "title": "Harmony 3 Wireless application examples for PIC32MZ W1 family  v3.6.0",
    "content": "Development kit and demo application support . Following table provides number of Wireless examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ W1 Curiosity Board | 19 | . New Features . | New IFTTT and Web Socket Server demos added | Please refer to the system services release notes. | . Bug fixes and Improvements . | Please refer to the system services release notes. | . Known Issues . | Due to an underlying issue in the underlying net repo, you need to turn off -Werror for the icmp.c file in your projects. | L2 Bridging is known to have some instabilities when there is high network data traffic. | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | DFP 1.5.203 | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v360",
    "relUrl": "/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v360"
  },"128": {
    "doc": "Release notes",
    "title": "Harmony 3 Wireless application examples for PIC32MZ W1 family  v3.5.1",
    "content": "Note : This is an incremental release. All notes under the v3.5.0 release are applicable to this release as well. Development kit and demo application support . Following table provides number of Wireless examples available for different development kits. | Development Kits | MPLABx applications | . | PIC32MZ W1 Curiosity Board | 17 | . New Features . | Please refer to the system services release notes. | . Bug fixes and Improvements . | Please refer to the system services release notes. | . Known Issues . | Due to an underlying issue in the DHCP code in net repo, compiler optimization should be turned off in the dual interface project. | L2 Bridging is known to have some instabilities when there is high network data traffic. | . Development Tools . | MPLAB® X IDE v5.50 | MPLAB® X IDE plug-ins: . | MPLAB® Harmony Configurator (MHC) v3.8.0 | . | MPLAB® XC32 C/C++ Compiler v3.01 | . ",
    "url": "http://localhost:4000/wireless_apps_pic32mzw1_wfi32e01/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v351",
    "relUrl": "/release_notes.html#harmony-3-wireless-application-examples-for-pic32mz-w1-family--v351"
  },"129": {
    "doc": "Release notes",
