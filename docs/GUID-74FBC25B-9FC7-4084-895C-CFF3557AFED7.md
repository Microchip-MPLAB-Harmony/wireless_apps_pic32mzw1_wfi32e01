...
1.  **In software using Wolfcrypt \(ota\_booloader\_wolfcrypt.x\)**
    ...
    -   This configuration uses `wolfcrypt` library, to verify siganture of image. ![wolfcrypt](GUID-372868FA-B3F9-464A-99C8-123DA4FA8113-low.png)
...
2.  **In Hardware using Trust Flex device \(ota\_booloader\_trustflex.x\)**
    ...
    -   In MHC, `ATECC608` component is configured for signature verification. ![ATECC608](GUID-7A952D0E-CAFF-49D5-A6C0-46BE28F8B994-low.png)
...
3.  Device Firmware
    ...
    -   When the firmware boots-up, the UART console \(15008N1\) will display the devices detected.
        ...
        ![trust_flex_image2](GUID-F930392E-306C-44E3-B8E5-2902320382CF-low.png) ![trust_flex_image3](GUID-28D24819-347C-43B2-81D0-640327534D58-low.png)
...
4.  Loading the Public Key for FW verification \(Provisioning\)
    ...
    -   Open TPDS and select ATECC608-TFXTLS configurator under the "Select Security Solution" Tab.
        ...
        ![trust_flex_image4](GUID-DC9DD2C5-2D0C-4470-B492-F4F8D14BFB5F-low.png)
    ...
    -   Generate a provisioning package and use it to provision the sample.
        ...
        -   The attached kit with the trustFlex device mounted on it will be automatically detected and provisioned. ![trust_flex_image7](GUID-2F66428B-B8C9-4F39-AEA5-FE343BF63FEE-low.png) ![trust_flex_image8](GUID-7237F582-F85B-41C0-9EE0-9FCD0D5ACCB8-low.png)
...
2.  Define "SYS\_OTA\_SECURE\_BOOT\_ENABLED" in "bootloader.h" of bootloader project. User can simply uncomment line of code in "bootloader.h" as shown in below image : ![define_secure_boot](GUID-64E3542B-D374-42B0-97FF-CF5992F28496-low.png)
