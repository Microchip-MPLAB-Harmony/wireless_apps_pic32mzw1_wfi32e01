...
-   In paho mqtt client power save application, user is requested to ensure that plib\_clk.c, app\_mqtt.c , app\_mqtt.h,app.c and app.h files are not overwritten with generated code.
